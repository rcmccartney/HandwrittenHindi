function [net, info] = devnagari(varargin)

run(fullfile('C:\Users\Henry\Box Sync\Projects\matconvnet-master\matlab', ...
    'vl_setupnn.m')) ;

opts.dataDir = fullfile('data');
opts.expDir = fullfile(opts.dataDir, 'devnagari');
opts.loadMat = fullfile(opts.expDir, 'devnagariNormalized.mat');
