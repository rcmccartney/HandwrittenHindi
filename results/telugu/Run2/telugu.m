function [net, info] = tamil(varargin)
% Added two layers of dropout
% changed numEpochs to 100 due to fast convergence seen in Run1
% changed momentum to .95 for dropout
% changed learning rates to allow more variation at first
